...
// propModelPaths maps prop ID to asset path (relative to assets/models/dungeon/).
...
// Per-model scale multipliers (relative to wallScale). Most props use 1.0.
...
func drawLocal(
	...
	halfTileOff := tileUnit * 0.35 // offset for wall-adjacent props
